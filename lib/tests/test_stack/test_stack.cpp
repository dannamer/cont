...
TEST_F(TEST_STACK, Constructor_Default) {
  s21::stack<int> our_stack;
  std::stack<int> std_stack;
  EXPECT_EQ(our_stack.empty(), std_stack.empty());
}

TEST_F(TEST_STACK, Constructor_List) {
...
TEST_F(TEST_STACK, Constructor_Copy) {
  s21::stack<int> our_stack = {1, 2, 3};
...
TEST_F(TEST_STACK, Operator_Copy) {
...
TEST_F(TEST_STACK, Constructor_Move) {
  s21::stack<int> our_stack = {1, 2, 3};
...
TEST_F(TEST_STACK, Operator_Move) {
  s21::stack<int> our_stack_int = {1, 2, 3};
  std::stack<int> std_stack_int;
  std_stack_int.push(1);
  std_stack_int.push(2);
